...
class NewsArticle extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            headlines: this.props.combinedNews.map((e) => e[0].headline),
            summarys: this.props.combinedNews.map(e => e[0].summary),
            images: this.props.combinedNews.map(e => e[0].image),
            urls: this.props.combinedNews.map(e => e[0].url),
        }
    }
